...
import {ActionSheetIOS, Alert, FlatList, Image, Platform, Text, TextInput, TouchableOpacity, View} from "react-native";
...
export class Observation extends React.Component {
    ...
    _onPressSendButton() {
        Alert.alert('You wanna send off your comment wow');
    }
                ...
                <View name={'wrapper'} >
                    ...
                    <FlatList name={'comments'} style={[styles.containerPadding, {flex: 1, flexDirection:'column'}]}
                              data={[
                                  ...
                                  {key: '2', value:{userid:123, imageid:'123', message:'Mmh, so jelly!'}},
                              ...
                              renderItem={({item}) =>
                                  <View style={{flex: 1, flexDirection:'row', alignItems: 'center'}}>
                                      ...
                                      <Text style={[styles.textStandard, styles.containerPadding]}>{item.value.message}</Text>
                                  </View>}
                              ListFooterComponent={() =>
                                  <View style={{flex: 1, flexDirection:'row', alignItems: 'center'}}>
...
//TOOD: keyboard reopens when alert dismissed, send action, 3+ comments