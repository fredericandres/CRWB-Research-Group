...
// from https://github.com/expo/react-native-read-more-text; had to create own file because sometimes limitedHeight is
// almost as large as fullHeight, so we need to add Math.ceil() to limitedHeight to avoid showing useless ReadMores
...
export default class ReadMore extends React.Component {
    ...
    async componentDidMount() {
        ...
        if (fullHeight > Math.ceil(limitedHeight)) {
