...
(function() {
   ...
   * @type {number}
   */
  tracking.ColorTracker.prototype.minGroupSize = 2;
...
tracking.ColorTracker.registerColor('green', function(r, g, b) {
    ...
    return dx * dx + dy * dy + dz * dz < 18000;
  });
...
tracking.ColorTracker.registerColor('brown', function(r, g, b) {
    ...
    if ((r - g) >= 8 && (r-g)<20 && (r - b) >= 20) {
      return true;
    }
    return dx * dx + dy * dy + dz * dz < 15000;
  });

tracking.ColorTracker.registerColor('brownOrange', function(r, g, b) {
    var threshold = 35,
      dx = r - 255,
      dy = g - 0,
      dz = b - 0;

    if ((r - g) >= 41 && (r-g)<54 && (r - b) >= 36 &&(r - b) < 48) {
      return true;
    }
    return dx * dx + dy * dy + dz * dz < 25000;
  });

tracking.ColorTracker.registerColor('redOrange', function(r, g, b) {
    var threshold = 35,
      dx = r - 255,
      dy = g - 0,
      dz = b - 0;

    if ((r - g) >= 102 && (r-g)<127 && (r - b) == 0) {
      return true;
    }
    return dx * dx + dy * dy + dz * dz < 10000;
  });

tracking.ColorTracker.registerColor('darkbrown', function(r, g, b) {
      dx = r - 255,
      dy = g - 0,
      dz = b - 0;

    if ((r - g) >= 18 && (r-g)<71 && (r - b) >= 58 && (r - b) < 71) {
      return true;
    }
    return dx * dx + dy * dy + dz * dz < 34000;
  });

tracking.ColorTracker.registerColor('lightbrown', function(r, g, b) {
      dx = r - 255,
      dy = g - 0,
      dz = b - 0;

    if ((r - g) >= 70 && (r-g)<106 && (r - b) > 35) {
      return true;
    }
    return dx * dx + dy * dy + dz * dz < 34000;
  });
